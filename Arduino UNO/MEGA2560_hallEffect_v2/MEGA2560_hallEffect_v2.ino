...
unsigned long timer1sec=millis(),timer1min=millis(),timer1hour=millis(),timerInline0=millis(),timerDisplay=millis();
...
void showDisplay()
{
 if(one)
  ...
  lcd.setCursor(4,0);
  lcd.print(pulseVolts1);
  lcd.setCursor(4,1);
  lcd.print(pulseVolts2);
  lcd.setCursor(4,2);
  lcd.print(pulseVolts3);
  lcd.setCursor(4,3);
  lcd.print(pulseVolts4);

  lcd.setCursor(14,0);
  lcd.print(pulseVolts5);
  lcd.setCursor(14,1);
  lcd.print(pulseVolts6);
  lcd.setCursor(14,2);
  lcd.print(pulseVolts7);
  lcd.setCursor(14,3);
  lcd.print(pulseVolts8);         
  }
}
